...
export default async function handler(req, res) {
  ...
  const { name, type, parentPath, cloudId = null, adobeMetadata = null, fileId = null } = req.body;
  ...
  await Item.create({ name, type, path, parentPath: cleanParent, cloudId, adobeMetadata, fileId, children: type === 'folder' ? [] : undefined });
